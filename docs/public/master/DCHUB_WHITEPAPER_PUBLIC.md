...
- **Reference specifications (normative for interoperability)**:
  ...
  - Reference Indexer Specification and export formats,
...
- A **litepaper or investor brief** that focuses on vision, architecture, token model, and adoption path.
- An **NGO specific note** that focuses on nonprofit modules, donor transparency, and jurisdiction adapter patterns for charities.
- Developer documentation and module specifications that focus on APIs and implementation details.
...
The normative cadence, schemas, proofs, and failure handling rules are defined in the **Subchain Anchoring Standard** (see section 18.4).
...
- **Provider Attestation Framework**
...
- **Pilot Showcase**
  - Living dashboards and case studies (separate from the normative specification documents).
