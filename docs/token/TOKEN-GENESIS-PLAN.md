...
- **Supply creation**: the full hard-cap supply is created once at genesis and assigned into vesting accounts and governance-controlled module accounts (no discretionary inflation beyond genesis; see `docs/master/DCHUB_MASTER.md`, section 10.3).
...
Indicative v1 schedules (see `docs/master/DCHUB_MASTER.md`, section 10.4 and 10.4A):
