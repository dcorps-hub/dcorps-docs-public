...
- The byte-exact canonical 34-paragraph Founder Manifesto V1.0 distribution
  copy adopted on 2026-07-21 is authorized under `docs/manifesto/` for local
...
- Do not alter the canonical Manifesto's 34 paragraphs or import an old role,
...
- Commit and push only under explicit owner authority. Production publication
